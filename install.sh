...
echo "     ${GREEN}sudo ngrokd --config=/etc/ngrokd/config.yml${NC}"
echo ""
echo "  2. In another terminal, set your API key:"
echo "     ${GREEN}ngrokctl set-api-key YOUR_NGROK_API_KEY${NC}"
echo ""
echo "  3. Check status:"
echo "     ${GREEN}ngrokctl status${NC}"
echo ""
echo "  4. List endpoints (after 30s):"
echo "     ${GREEN}ngrokctl list${NC}"
echo ""
echo "  5. Test connection:"
echo "     ${GREEN}curl http://your-endpoint.ngrok.app/${NC}"
echo ""
